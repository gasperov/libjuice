...
int test_turn_tcp() {
	...
	turn_server.transport = JUICE_TURN_TRANSPORT_TCP;

	// Agent 1: Create agent with TURN-TCP
	...
	// Agent 2: Create agent with TURN-TCP
	...
	if (success &=
		...
		// Both agents use relay, so both local and remote must be relay
